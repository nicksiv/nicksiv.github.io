nyk0-nomikon - Things I do after installing XFCE
...
Super+E : thunar (file manager) Ctrl+Alt+T: xfce4-terminal Super+D : dmenu_run (needs the package suckless-tools)
